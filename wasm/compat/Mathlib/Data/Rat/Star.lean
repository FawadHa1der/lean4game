/-
wasm/compat: copy of mathlib4 de3a9cf `Mathlib.Data.Rat.Star` (Apache-2.0; see
wasm/compat/README.md). The essential pack excludes this leaf; Robo imports it.
Only edit: the module-system keywords (`module`, `public import`, `public section`)
are removed — with them the 4.33.0-pre IR interpreter aborts while elaborating
`Rat.addSubmonoid_closure_range_pow` ("fn_body_kind::Unreachable",
ir_interpreter.cpp:928); the classic form of the same file compiles unchanged.
-/
/-
